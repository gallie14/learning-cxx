...
int main(int argc, char **argv) {
    {
        ...
        // std::vector 的大小（sizeof）是固定的，包含指向堆内存的指针、大小和容量等信息
        // 通常是3个指针的大小（24字节在64位系统上）
    ...
    }
    {
        ...
        }
        {
            ...
            ASSERT(sizeof(vec) == 24, "Fill in the correct value."); // sizeof不变，因为vector对象本身大小不变
            vec.pop_back();
            ASSERT(vec.size() == 5, "Fill in the correct value.");
            ASSERT(sizeof(vec) == 24, "Fill in the correct value.");
        }
        ...
        }
        {
            ...
            ASSERT(vec.capacity() == 5, "Fill in the correct value."); // capacity可能保持不变
        }
    }
    {
        ...
        }
        {
            ...
            ASSERT(vec.capacity() == 256, "Fill in the correct value.");
            ASSERT(vec[15] == 'z', "Fill in the correct value."); // 原来的第16个元素
